...
*Bai, J., Niu, Z., Zhu, J., et al. (2025). HIDEDaSF: a detection and correction framework for edge effect on hyperspectral intensity data for novel hyperspectral LiDAR remote sensor.*
